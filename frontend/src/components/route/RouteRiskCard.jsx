import { AlertTriangle, ShieldQuestion, ShieldCheck, RouteOff } from "lucide-react";
...
export default function RouteRiskCard({ summary, onViewAlternative }) {
  ...
  return (
    <Card className="w-full bg-card/95 p-4 shadow-card backdrop-blur sm:p-5">
